...
cred = credentials.Certificate("C:/Users/Nurdaulet/Desktop/codes/nurlan_bot/dom/key.json")
...
def begin():
    ...
    while True:
        url = "https://krisha.kz/arenda/doma/nur-sultan/?das[_sys.hasphoto]=1&das[rent.period]=2&das[who]=1&page=" + str(page)
        driver = webdriver.Chrome(
            executable_path='C:/Users/Nurdaulet/Desktop/codes/nurlan_bot/dom/chromedriver.exe',
            options = options
            ...
            for el in items:
                ...
                if day == today_day:
                        ...
                        if check == data_id:
                            ...
                            bot.send_media_group("-1001668805062", media = media)
                            time.sleep(5)
                            #for file in files:
                                #os.close(file)
                                #os.remove(file)
